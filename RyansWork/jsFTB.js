...
function submit() {
    ...
    var fourthInput = document.getElementById("userInput4").value.toUpperCase().toLowerCase();
    ...
    var eleventhInput = document.getElementById("userInput11").value.toUpperCase().toLowerCase();
    var twelfthInput = document.getElementById("userInput12").value.toUpperCase().toLowerCase();
    var thirteenthInput = document.getElementById("userInput13").value;
    var fourteenthInput = document.getElementById("userInput14").value.toUpperCase().toLowerCase();
    var fifteenthInput = document.getElementById("userInput15").value;
    var sixteenthInput = document.getElementById("userInput16").value.toUpperCase().toLowerCase();
